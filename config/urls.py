...
urlpatterns = [
                  ...
                  path('api/v1/conversation/', include('ausers.urls')),
                  path('api/v1/', include('stripe_payment.urls')),
                  # auth
                  ...
                  # re_path(r'^api/v1/auth/social-login/', include('drf_social_oauth2.urls', namespace='drf')),
                  # swagger docs
